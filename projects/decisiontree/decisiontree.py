...
class DecisionTree:
    def __init__(self, filename):
        self.X, self.Y = self._data_from_file(filename)
        self.tree = None
    ...
    def _data_from_file(self, filename):
        x, y = [], []
...
decision_tree = DecisionTree('data_banknote_authentication.txt')
